...
Note: This application requires the sutch-anemone gem, a branch Anemone, to allow the capture of all website
responses/resources.
...
configuration for spidering and parsing the website, as well as the static copy of the website.
...
* serve_info -- to provide a web interface to information about the copy of the website
* serve_web -- to browse the static copy of the website
...
== Examples
  ...
  % wmonk -p ~/sites/example.com serve_web
